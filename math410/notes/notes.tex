...
\begin{corollary}
  \vocab{Comparison Test}. $\{a_n\}, \{b_n\}$ sequences with $0 \leq a_k \leq b_k \ \forall \ k$. 
  \begin{itemize}
...
\begin{theorem}
  \vocab{Integral Test}. Let $\{a_k\}$ be a sequence of nonnegative numbers and suppose $f: [1, \infty) \to \RR$
